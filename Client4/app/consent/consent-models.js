(function () {
    ...
    angular.module('models-factory', ['services-factory']);

    angular.module('models-factory').factory("EducationData", function () {
    //app.factory("EducationData", function () {
    ...
    angular.module('models-factory').factory("ConsentModel", function (Utilities, MVR, DataDrop) {
