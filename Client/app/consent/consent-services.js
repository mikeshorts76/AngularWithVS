...
consentApp.factory('State', function($resource){
    return $resource('/states', {}, {
        'find': {method:'GET', isArray:true}
    });
});

consentApp.factory('ConsentService', function($resource, DataDrop){
...
consentApp.factory('ConsentSubmitService', function($resource, DataDrop){
    return $resource('consent/:_code/submit', {_code: DataDrop.data.code}, {
    });
});

consentApp.factory('DataDrop', function(){
    return choice.dataDrop;
});

consentApp.factory('Toastr', function(){
    toastr.options = { positionClass: 'toast-top-full-width' };
    return toastr;
});

consentApp.factory("PrintService", function($timeout){
    return {
...
consentApp.factory('BrowserDetect', function(){
    var BrowserDetect = {
        init: function () {
...
consentApp.factory('MVR', function(){
    return {
